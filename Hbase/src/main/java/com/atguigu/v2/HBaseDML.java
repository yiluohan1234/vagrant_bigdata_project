...
public class HBaseDML {
    ...
    public static void filterScan(String namespace, String tableName,
                                  String startRow, String stopRow, String columnFamily, String columnName, String value) throws IOException {
        // 1. 获取 table
        Table table = connection.getTable(TableName.valueOf(namespace, tableName));
...
//        filterScan("bigdata", "student", "1001", "2000", "info", "name", "zhangsan");
